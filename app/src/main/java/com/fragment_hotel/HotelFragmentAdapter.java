...
public class HotelFragmentAdapter extends RecyclerView.Adapter<HotelFragmentAdapter.ViewHolder> {
    ...
    public HotelFragmentAdapter(List<TestItem> itemList) {
        mTestItem = itemList;
    }

    @NonNull
    @Override
    public HotelFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (mContext == null) {
